...
function cardealer_sysinfo_get()
{
    global $wpdb;
    global $cardealer_userAgentOri;
    // Get theme info
    ...
    $return .= 'Version:                  ' . CARDEALERVERSION;
    $return .= "\n\n";
    $return .= '-- Site Info' . "\n\n";
    ...
    $return .= "\n" . '-- User Browser' . "\n\n";
    $return .= $cardealer_userAgentOri; // $browser;
    $return .= "\n\n";
    $locale = get_locale();
    ...
    $return .= 'Plugin Dir:                  ' . CARDEALERPATH . "\n";
    $return .= 'Table Prefix:             ' . 'Length: ' . strlen($wpdb->prefix) . '   Status: ' . (strlen($wpdb->prefix) > 16 ? 'ERROR: Too long' : 'Acceptable') . "\n";
    //$return .= 'Admin AJAX:               ' . ( cardealer_test_ajax_works() ? 'Accessible' : 'Inaccessible' ) . "\n";
    ...
    $return .= 'OS Type & Version:        ' . cardealer_OSName();
