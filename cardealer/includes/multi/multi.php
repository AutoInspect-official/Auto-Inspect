...
function cardealer_dbase_get_callback()
{
    ...
    */
    ...
    if (!wp_verify_nonce($nonce, 'cardealer_cfield')) {
        wp_die('Nonce Fail.');
    }
    */

    if (current_user_can('manage_options')) {
        // The user has permission to manage options (usually administrators).
        //echo 'You have permission to access this area.';
    } else {
        // The user does not have the required permission.
        wp_die('Access denied. You do not have permission to perform this action.');
    }
